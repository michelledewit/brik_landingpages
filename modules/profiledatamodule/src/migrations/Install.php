...
namespace modules\profiledatamodule\migrations;
...
class Install extends Migration
{
    ...
    // profiledatamodule_profiledatamodulerecord table
        ...
        $tableSchema = Craft::$app->db->schema->getTableSchema($tableTotal);
        if ($tableSchema === null) {
            $tablesCreated = true;
    ...
    protected function createIndexes()
    {
        ...
        $this->createIndex($this->db->getIndexName(
            $table,
            'sessionKey',
            false
        ), $table, 'sessionKey', false);

        $this->createIndex($this->db->getIndexName(
            $tableTotal,
            'sessionKey',
            true
        ), $tableTotal, 'sessionKey', true);
