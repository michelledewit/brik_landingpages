...
namespace modules\profiledatamodule\widgets;

use modules\profiledatamodule\ProfiledataModule;
use modules\profiledatamodule\assetbundles\profiledatamodulewidgetwidget\ProfiledataModuleWidgetWidgetAsset;
 ...
 * @since     0.0.1
 */
class ProfiledataModuleWidget extends Widget
{
    ...
    {
        return Craft::t('profiledata-module', 'ProfiledataModuleWidget');
    }
    ...
    {
        return Craft::getAlias("@modules/profiledatamodule/assetbundles/profiledatamodulewidgetwidget/dist/img/ProfiledataModuleWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'profiledata-module/_components/widgets/ProfiledataModuleWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(ProfiledataModuleWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'profiledata-module/_components/widgets/ProfiledataModuleWidget_body',
            [
